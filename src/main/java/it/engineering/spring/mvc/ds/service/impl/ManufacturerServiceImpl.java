...
public class ManufacturerServiceImpl implements ManufacturerService {
	...
	@Autowired
	public ManufacturerServiceImpl(ManufacturerDao manufacturerDao, CityDao cityDao,
...
//		manufacturerEntity.setCity(cityEntity);
	...
	public ManufacturerDto findById(Long id) throws Exception {
		...
		if (manufacturerEntity==null) throw new ExistEntityException(manufacturerEntity,
				"Proizvodjac ne postoji!");
	...
	public ManufacturerDto update(ManufacturerDto manufacturerDto) throws Exception {
		...
		if (entity == null)
			throw new ExistEntityException(entity, "Proizvodjac ne postoji!");
