...
public class CityServiceImpl  implements CityService{
	...
	public CityServiceImpl(CityDao cityDao, 
							CityConverterDtoEntity cityConverterDtoEntity) throws Exception {
	...
	public void save(CityDto cityDto) throws Exception{
		...
		if (existingCity!=null) {
			throw new ExistEntityException(cityDto,
					"City with code number " + cityDto.getNumber()+" already exist!");
		}
